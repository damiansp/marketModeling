...
TDAM_VALUE = 10641
FRAC_IN = 0.5400
FID_MAX = 0.08  # max weight to give my picks in fid acct
RSI_VALUE = 102838
ADEL_VALUE = 99380
...
def main():
    ...
    current_best_stocks = ['ADUS', 'AMBA', 'AVGO', 'AXON', 'CROX', 'CSIQ', 'EPAM', 'FRO', 'LFMD', 'MANH', 'MCVT', 'NFLX', 'NOAH', 'PCRX', 'PRTA', 'SSTK', 'SYNA', 'TSLA', 'UI', 'URI']
    transactions = (
