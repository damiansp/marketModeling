...
# Daily inputs:
FID_VALUE =   267844  # [217831, 268265]
ET_VALUE =    210862  # [167274, 211207]
SCHWAB_VALUE = 18074  # [ 14775,  18141]
SIM1_VALUE =  116772
SIM2_VALUE =  295263
SIM3_VALUE =  239149
SIM4_VALUE =  219837
...
#                     mine,   sp,     nas,    dow,    rus
fracs     = np.array([0.6375, 1,      1,      0.9999, 1])
...
P_STATS0_BUY = {
    ...
    'sim1':   {'buy': 0.01, 'sell': 0.36},  #         4 adelaide 2024
