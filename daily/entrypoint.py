...
# Daily inputs:
FID_VALUE =   280200  # [232208, 280617]
ET_VALUE =    232784  # [199256, 242985]
SCHWAB_VALUE = 24272  # [ 17415,  24272]
SIM1_VALUE =  218405
SIM2_VALUE =  242525
SIM3_VALUE =  226730
SIM4_VALUE =  233778
...
SECOND_BEST_SIM = 4
# n weeks needed: 14 / 40 market days - same if new; expand if same
#      1st   2nd
...
#                     mine,   sp,     nas,    dow,    rus
fracs     = np.array([0.765,  0.9983, 1,      0.9989, 1])
f_weights = np.array([0.3,    0.25,   0.25,   0.1,    0.1])

THUMB_FRAC = 0.63  # 1 = no thumb (current min: 62, current max: 80)
