...
# Daily inputs:
FID_VALUE =   283042  # [232208, 284559]
ET_VALUE =    235141  # [199256, 242985]
SCHWAB_VALUE = 34590  # [ 17415,  34826]
SIM1_VALUE =  223537
SIM2_VALUE =  248321
SIM3_VALUE =  227804
SIM4_VALUE =  240143
...
SECOND_BEST_SIM = 4
# n weeks needed: 23 / 40 market days - same if new; expand if same
#      1st   2nd
...
#                     mine,   sp,     nas,    dow,    rus
fracs     = np.array([0.72675,1,      1,      1,      1])
