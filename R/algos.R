...
wlsh.osc <- c(
  ...
  -47,-53,-66,-70,-70,-70,-65,-60,-59,-58,-55,-56.357)
...
# Tue
wil5 <- c(0.9329, 1, 0.9947)
nas5 <- c(1, 1, 1)

# Wed    
wil10 <- c(0.1717, 0.8414, 0.9817)
nas10 <- c(1, 1, 0.9903)

# Thu
wil20 <- c(0, 0.9927, 0.0050)
nas20 <- c(1, 1, 0.9959)

# Fri
nya35 <- c(1, 0.9904, 0.9910)
...
# For 401(k): # Next: 30 Aug (10% Change Required)
(f1k.total <- f1kVal[length(f1kVal)]) # [118811, 139344] [2-param]
