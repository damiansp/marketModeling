...
fid.in <- c(
  df$fid.in,     161785,161785,161785,161785,161785,161785,161785,162813,162813,
   ...
   166703,166703,166703,166703) # +512
fid.val <- c(
...
f1k.in <- c(
  df$f1k.in,      18031, 18031, 18031, 18031, 18031, 18031, 18031, 18031, 18031,
    ...
    27114, 27114, 27114, 27114) # (1133.49)
f1k.val <- c(
...
(f1k.total <- f1k.val[length(f1k.val)])              # [ 18063  31384] 
(self.mng.amt <- self.mng.val[length(self.mng.val)]) # [  9514  15454]
