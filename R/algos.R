...
# Buy when low:
# AAPL, AMZN, CRM, DIS, GOOG, MA, MSFT, ROL, TSLA, ZM, INTG ($30)
# Dutch Bros., Duolingo
...
wlsh.osc <- c(
  ...
  -78,-87,-89,-88,-88,-85,-82,-78,-75,-72,-68,-62,-58,-54,-55,-50.199)
...
SPActual <- c(df$SPActual,
    ...
    4291,  4292,  4298,  4320,  4352,  4344,  4358,  4321,  4370)
...
FidIn <- c(df$FidIn,
   ...
   57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134,
   57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134,
   57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134)
...
FidVal <- c(df$FidVal,
  ...
  114655,115227,114738,113886,113655,113854,112754,112029,113204)
Fid <- FidVal / FidIn
Fid <- Fid / Fid[last]
...
f1kIn <- c(df$f1kIn,
   ...
   89789, 89789, 90495, 90495, 90495, 90495, 90495, 90495, 90495) # 
f1kVal <- c(df$f1kVal,
  ...
  135863,135993,137122,137346,137599,137602,136866,136633,137330)
payment <- 1018.67
n <- length(f1kIn)
...
OHIn <- c(df$OHIn,
   ...
   41225, 41225, 41225, 41554, 41554, 41554, 41554, 41554, 41554) #
OHVal <- c(df$OHVal, 
  ...
  101622,101246,103242,102694,103325,102648,102961,100355,101452, 87037, 86693,
   ...
   96973, 97244, 96882, 96997, 96828, 96908, 96155, 95585, 96308) # 
OH <- OHVal / OHIn
OH <- OH / OH[last]
OHd <- dailyChange(OH)
...
m1 <- (c(
  ...
  117336,110919,108642,108221,101922,104631,106850,105531, 98774, 94278, 93620,
   ...
   97078, 98109, 98347, 97469, 96946, 96940, 97630, 96852, 96307, 96997)
  / 100000)
qp.start <- 92
m1.name <- 'BuyNHold'
...
m2 <- (c(
  ...
  107042,109327,109750,109085,108087,107800,108262,106892,105908,107218)
  / 100000) 
...
m3.raw <- c(
  ...
  106606,108870,109482,108981,107739,107308,107691,105997,105285,106644)
m3 <- m3.raw / 100000
m3.name <- 'CashInLow'
#len <- length(m3)
...
m4.raw <- c(
  ...
  100601,102336,102610,101743,100431,100413,101600,100537, 99619,100771)
m4 <- m4.raw / 100000
m4.name <- 'CashInHigh'
...
m5 <- (c(
  ...
  106723,108987,109407,108546,107090,106711,107290,105885,105517,106285)
  / 100000)
m5.name <- '30/70'  
...
m6 <- (c(
  ...
  103654,105851,106145,105338,104049,103899,104307,102843,101821,103158)
  / 100000)
m6.name <- 'rsi each'  
...
m7 <- (c(
  ...
  101495,103226,103557,103000,102029,102020,102376,101312,100602,101602)
  / 100000)
m7.name <- 'rsi overall'  
...
# Tue
wil5 <- c(0.9362, 1, 0.9880)
nas5 <- c(1, 1, 1)

# Wed    
wil10 <- c(0.9992, 0.8119, 0)
nas10 <- c(1, 1, 0.9908)

# Thu
wil20 <- c(0.0209, 0.0001, 0.0130)
nas20 <- c(1, 1, 0.9953)

# Fri
nya35 <- c(1, 0.9930, 0)
nas35 <- c(0.9989, 0.9999, 1)

# Sat
nya50 <- c(1, 1, 0.9912)
nas50 <- c(0.9999, 1, 0.9909)
...
(f1k.total <- f1kVal[length(f1kVal)]) # [118811, 137602] [2-param]
