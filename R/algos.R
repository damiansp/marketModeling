...
sp.actual <- c(
  df$sp.actual,    6858,  6902,  6945,  6921,  6921,  6966)

fid.in <- c( 
  df$fid.in,     172299,172299,172299,172299,172299,172299)
fid.val <- c(
  df$fid.val,    290094,294181,296138,295822,295959,297678)

f1k.in <- c(
  df$f1k.in,      66140, 66140, 66140, 66140, 66140, 66140)  # (1125.13)
f1k.val <- c(
  df$f1k.val,    119907,120000,121051,121811,121648,121593)  #

self.mng.in <- c(
  df$self.mng.in, 25017, 25017, 25017, 25017, 25017, 25017)  #
self.mng.val <- c(
  df$self.mng.val,35889, 36262, 36552, 36362, 36617, 36757)  #

et.in <- c(
  df$et.in,      101275,101275,101275,101275,101275,101275)  #
et.val <-c(
  df$et.val,     259715,263830,267624,266268,268148,270396)  #

sim1 <- (c(
          100000,100000,100000,100000,100002, 99964, 99955)
  / 100000)
sim1.res <- 198737
...
sim2 <- (c(
          100000,100003,100020,100064, 99976,100074,100105)
  / 100000)
sim2.res <- 187542
...
sim3 <- (c(
          100000,100000,100000,100000,100004, 99982, 99974)
  / 100000)
sim3.res <- 196371
...
sim5 <- (c(
          100000,100275,102541,104265,102645,102968,104032)
  / 100000)
sim5.res <- 19203
...
extr <- (c(
          100000,100000,100000,100000,100020, 89687, 99597)
  / 100000)
extr.res <- 188496
