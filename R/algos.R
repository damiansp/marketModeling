...
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    230492,231121,234023,230335,227764) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     46377, 46377, 46377, 47106, 47106) # (1062.63)
f1k.val <- c(
...
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    179820,181277,183210,180633,176273) #
...
sim1 <- (c(
    ...
    103929,104266,105237,103533,101957)
  / 100000)
sim1.res <- 14251
...
sim2 <- (c(
    ...
    111472,116798,120334,116236,112745)
  / 100000)
sim2.res <- 27896
...
sim3 <- (c(
    ...
    113342,118055,121977,117278,113981)
  / 100000)
sim3.res <- 27949
...
sim5 <- (c(
    ...
    105346,104116,106826,100338, 95865)
  / 100000)
sim5.res <- 15314
