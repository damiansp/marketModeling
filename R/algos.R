...
fid.val <- c(
  ...
  261355,258084,259909,256280,256129,258779) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   55489, 55489, 55489, 55489, 55489, 55489) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   86512, 86566, 84856, 86022, 84215, 83600) #
...
self.mng.in <- c(
  df$self.mng.in,13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857,
   ...
   13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857,
   13857, 13857, 13857, 13857, 13857, 17835)  #
self.mng.val <- c(
  df$self.mng.val, 
   ...
   18091, 17754, 17846, 17434, 17415, 22661)  #
...
et.in <- c(
  df$et.in,      92607, 92997, 93120, 93120, 93120, 93120, 93120, 93120, 93120,
   ...
   94356, 94849, 94849, 94849, 95147, 95147) #
et.val <-c(
  ...
  214842,213440,215769,211701,211811,213685) #
...
sim1 <- (c(
  ...
  106595, 99771,101143, 95632, 95166, 97095)
  / 100000)
sim1.res <- 39867
...
sim2 <- (c(
  ...
  107459,101726,102048, 95862, 96433, 97906)
  / 100000)
sim2.res <- 39758
...
sim3 <- (c(
  ...
  107653,100876,101690, 97486, 97629, 99421)
  / 100000)
sim3.res <- 40576
...
sim4 <- (c(
  ...
  110120,106259,107288,102506,102410,102956)
  / 100000)
sim4.res <- 41205
...
sim5 <- (c(
  ...
  107837,103843,104795, 99577, 99140,101146)
  / 100000)
sim5.res <- 41273
...
extr <- (c(
  ...
  100231, 94367, 96022, 89898, 88809, 91493)
  / 100000)
extr.res <- 2558
