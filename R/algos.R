...
fid.val <- c(
  ...
  268507,268281,268110,270148,268388) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   54794, 54794, 54794, 54794, 54794) # (1125.13)
f1k.val <- c(
...
et.val <-c(
  ...
  217701,217972,217679,219633,217747) #
...
sim1 <- (c(
  ...
  113902,110691,109092,109888,107978)
  / 100000)
sim1.res <- 54787
...
sim2 <- (c(
  ...
  111321,108203,107087,109465,109914)
  / 100000)
sim2.res <- 55860
...
sim3 <- (c(
  ...
  108678,107977,105346,108174,106194)
  / 100000)
sim3.res <- 53650
...
sim4 <- (c(
  ...
  109590,108722,106499,110335,108146)
  / 100000)
sim4.res <- 54244
...
sim5 <- (c(
  ...
  109289,107924,107408,110091,109686)
  / 100000)
sim5.res <- 56329
...
extr <- (c(
  ...
  107160,101994, 99580,101897,102595)
  / 100000)
extr.res <- 2954
