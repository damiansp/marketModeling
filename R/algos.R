...
sp.actual <- c(
  df$sp.actual,    3824,  3853,  3808,  3895,  3892,  3919,  3970,  3987,  3999,  
     ...
     4119,  4180,  4136,  4111,  4164,  4118,  4082,  4090)
...
fid.in <- c(
  df$fid.in,     161785,161785,161785,161785,161785,161785,161785,162813,162813,
   ...
   164033,164033,164033,164033,164033,164033,164033,164033) #
fid.val <- c(
  df$fid.val,    172350,175073,172978,176119,179159,182181,185241,188878,190980,
   ...
   205594,210527,207532,206046,207349,205374,203592,202266) #
...
f1k.in <- c(
  df$f1k.in,      18031, 18031, 18031, 18031, 18031, 18031, 18031, 18031, 18031,
    ...
    18933, 19964, 19964, 19964, 19964, 19964, 19964, 19964) # (1133.49)
f1k.val <- c(
...
self.mng.val <- c(
  df$self.mng.val, 9189,  9333,  9243,  9351,  9514,  9655,  9818,  9938, 10033,
    ...
    10669, 10791, 10687, 10560, 10609, 10508, 10402, 10401)
...
et.in <- c(
  df$et.in,       76890, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443,
    ...
    78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443) #
et.val <-c(
  df$et.val,     123916,128480,126726,128449,130010,131945,134582,135693,137333,
   ...
   148227,152885,149707,147752,149447,147340,146307,145299) #
...
rsi <- (c(
   ...
   107500,109571,107624,106488,107881,106734,105919,105350)
  / 100000)
...
adl <- (c(
   ...
   104631,107992,107866,104794,106118,104872,105104,105180)
  / 100000)
