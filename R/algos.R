...
sp.actual <- c(
  df$sp.actual,          6858,  6902,  6945,  6921,  6921,  6966,  6977,  6964,  
    ...
    7064,  7138,  7108,  7165,  7174,  7139,  7136,  7209,  7230)
...
fid.in <- c( 
  ...
  172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,
  172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,
  172299,172299,172299,172299,172299,172299,172299,172299,172299)
fid.val <- c(
  ...
  282150,286467,280320,283125,283350,280114,278679,281151,282665)
...
f1k.in <- c(
  df$f1k.in,            66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   ...
   69573, 69573, 69573, 69573, 69573, 69573, 69573, 69573, 69573)  # (1225) 3
f1k.val <- c(
  ...
  132091,130270,131030,130544,131104,130947,130511,130194,132684)  #
...
self.mng.in <- c(
  df$self.mng.in,       25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 
   ...
   25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017,
   25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017,
   25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017)  #
self.mng.val <- c(
  df$self.mng.val,      35889, 36262, 36552, 36362, 36617, 36757, 36901, 36708, 
   ...
   34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947,
   34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947)  #
...
et.in <- c(
  ...
  103877,103877,103877,103877,103877,103877,103877,103877,104123)  #
et.val <-c(
  ...
  263057,265363,259797,260838,261185,258143,256584,258879,259980)  #
...
sim1 <- (c(
  ...
  100447,103075,101470,101236, 97476, 95371, 91073, 90534, 92276, 93431, 90804,
   ...
   99891,100976, 95690, 97684, 96391, 94597, 93486, 95454, 96773)
  / 100000)
sim1.res <- 50176
...
sim2 <- (c(
  ...
  100237, 99802, 99357, 98890, 99145,100149,100860,101886,101105,100631, 97866,
   ...
   98462, 99260, 94024, 96130, 94844, 93174, 92095, 94040, 94940)
  / 100000)
sim2.res <- 46372
...
sim3 <- (c(
  ...
  100122, 99803, 99289, 98552, 98847,100121,101035,102200,101195,100316, 97071,
   ...
   94405, 95724, 90503, 92757, 91951, 90135, 88759, 91061, 92626)
  / 100000)
sim3.res <- 33970
...
sim4 <- (c(
  ...
  101631,103048,103451,102722,100487, 99349, 97266, 97488, 97739, 98233, 96480,
   ...
   97354, 98590, 95468, 96521, 96333, 95350, 94773, 95896, 96725)
  / 100000)
sim4.res <- 107780
...
sim5 <- (c(
  ...
  102461,104930,102263,103166,103393,100695, 99604,102966,103380)
  / 100000)
sim5.res <- 53752
...
extr <- (c(
  ...
  101135,101125,100388, 98194, 98419,100872,102571,105179,100641, 99465, 92140,
   ...
   71585, 73205, 65189, 67732, 67223, 66786, 66201, 65736, 69614)
  / 100000)
extr.res <- 4001
...
# Perf:    1st 2nd 3rd  Pts(2x1x0)  : day 4
# sim1       0   0   5    0
# fid        5   0   0   10
# et         0   5   0    5
