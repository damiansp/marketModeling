...
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    224858,225305,224032,224974,226345) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     41938, 41938, 41938, 41938, 41938) # (1062.63)
f1k.val <- c(
...
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    174774,175161,173555,175121,176185) #
...
sim1 <- (c(
    ...
    103257,102868,102540,102360,102660,103013,103286,102430,100591,100223, 99133,
     ...
     99191, 99400, 99387,100031, 99257)
  / 100000)
sim1.res <- 10043
sim1.name <- 'adelaide'
...
sim3 <- (c(
    ...
    100489,101338,100515, 99660, 98712)
  / 100000)
sim3.res <- 23070
sim3.name <- 'simsims'
