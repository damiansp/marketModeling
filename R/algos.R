...
fid.val <- c(
  ...
  274490,275589,276288,275995,277970) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   57760, 57760, 57760, 58451, 58451) # (1125.13)
f1k.val <- c(
...
et.in <- c(
  ...
  101985,101985,101985,101985,101985) #
et.val <-c(
  ...
  237290,238238,238709,238172,239329) #
...
sim1 <- (c(
  ...
  102560,104696,106303,104270,105848)
  / 100000)
sim1.res <- 31285
...
sim2 <- (c(
  ...
  112913,115031,116087,115452,117518)
  / 100000)
sim2.res <- 7812
...
sim3 <- (c(
  ...
  108213,110279,111840,110733,112616)
  / 100000)
sim3.res <- 25442
...
sim4 <- (c(
  ...
  109122,111736,113743,112003,113386)
  / 100000)
sim4.res <- 18416
...
sim5 <- (c(
  ...
  110912,112269,113596,111725,115434)
  / 100000)
sim5.res <- 6194
...
extr <- (c(
  ...
  115243,118864,119507,116880,119579)
  / 100000)
extr.res <- 2744
