...
sp.actual <- c(
  df$sp.actual,          6858,  6902,  6945,  6921,  6921,  6966,  6977,  6964,  
    ...
    6612,  6617,  6783,  6825,  6817,  6886,  6967,  7023,  7041,  7126)
...
fid.in <- c( 
  ...
  172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,
  172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,
  172299,172299,172299,172299,172299,172299,172299,172299,172299,172299)
fid.val <- c(
  ...
  268940,267282,270667,267286,266100,271667,274999,279494,281876,284438)
...
f1k.in <- c(
  df$f1k.in,            66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   ...
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   66140, 66140, 67541, 68225, 68225, 68225, 68225, 68225, 68225, 68225, 68225,
   68225, 68225, 68225, 68225, 68225, 68225, 68225, 68225, 68225, 68225)  # (1225) 3
f1k.val <- c(
  ...
  124361,124855,124891,128381,128454,128403,129794,130335,130317,130269)  #
...
self.mng.val <- c(
  df$self.mng.val,      35889, 36262, 36552, 36362, 36617, 36757, 36901, 36708, 
   ...
   34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947, 34947)  #
...
et.in <- c(
  ...
  103877,103877,103877,103877,103877,103877,103877,103877,103877,103877)  #
et.val <-c(
  ...
  249969,248106,251961,248875,247921,253448,256408,260755,262898,265991)  #
...
sim1 <- (c(
  ...
  100447,103075,101470,101236, 97476, 95371, 91073, 90534, 92276, 93431, 90804,
   ...
   89208, 87953, 91304, 88904, 86484, 91070, 93649, 97203, 98166,101057)
  / 100000)
sim1.res <- 40432
...
sim2 <- (c(
  ...
  100237, 99802, 99357, 98890, 99145,100149,100860,101886,101105,100631, 97866,
   ...
   87216, 86208, 89645, 87481, 85092, 89899, 92403, 95683, 96657, 99443)
  / 100000)
sim2.res <- 38776
...
sim3 <- (c(
  ...
  100122, 99803, 99289, 98552, 98847,100121,101035,102200,101195,100316, 97071,
   ...
   84632, 83192, 86231, 83238, 80498, 85459, 87733, 91418, 92773, 95450)
  / 100000)
sim3.res <- 35712
...
sim4 <- (c(
  ...
  101631,103048,103451,102722,100487, 99349, 97266, 97488, 97739, 98233, 96480,
   ...
   91862, 91092, 92464, 90435, 88503, 91840, 93606, 95485, 96527, 97924)
  / 100000)
sim4.res <- 103522
...
sim5 <- (c(
  ...
  101959,104118,101075, 98816, 96174,102206,104203,103607,102848, 98581,100217,
   ...
   88300, 88559, 93689, 93365, 93078, 95783, 97722,100104,100299,103527)
  / 100000)
sim5.res <- 35154
...
extr <- (c(
  ...
  101135,101125,100388, 98194, 98419,100872,102571,105179,100641, 99465, 92140,
   ...
   66403, 64815, 64845, 60655, 57820, 62486, 62981, 68028, 69930, 71139)
  / 100000)
extr.res <- 10649
...
# Perf:    1st 2nd 3rd  Pts(2x1x0)  : day 9
# sim1       2   0   6    4
# fid        6   1   2   13
# et         1   8   0   10
