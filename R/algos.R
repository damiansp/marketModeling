...
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    235110,235205,239054,234494,231546,230246) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     45676, 45676, 45676, 45676, 46377, 46377) # (1062.63)
f1k.val <- c(
  df$f1k.val,      48986, 48283, 47658, 47523, 47500, 48441, 48481, 48834, 48889,
     ...
     67798, 68261, 68458, 69204, 69290, 68561) #
...
self.mng.val <- c(
  df$self.mng.val, 16169, 15852, 15887, 15861, 16152, 16065, 16106, 16048, 15949,
     ...
     16389, 16428, 16774, 16718, 16473, 16424)  #
...
et.in <- c(
  df$et.in,        86278, 86278, 86278, 86278, 86278, 86278, 86278, 86278, 86588,
     ...
     88630, 88630, 88630, 88630, 88630, 88630) #
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    179340,179332,183045,182234,179218,178311) #
...
sim1 <- (c(
    ...
    103965,104274,105646,104637,103879,103288)
  / 100000)
sim1.res <- 14376
...
sim2 <- (c(
    ...
    108612,109034,114518,112262,108384,105341)
  / 100000)
sim2.res <- -2358
...
extr <- (c(
    ...
    100678,100494,100666,100437,100358, 98689)
  / 100000)
idx.only <- (c(
	                                                 rep(NA, 129), 100000, 99866,
     99970,101426,101818,100279, 98481, 97567)
  / 100000)
...
sim3 <- (c(
    ...
    110157,110549,116307,114002,111350,108050)
  / 100000)
sim3.res <- 27679
...
sim4 <- (c(
    ...
    102540,103044,104648,102637,101417, 99866)
  / 100000)
sim4.res <- 26279
...
sim5 <- (c(
    ...
    105116,107380,112545,113141,109772,101238)
  / 100000)
sim5.res <- 21550
