...
wlsh.osc <- c(
  ...
  -212,-220,-223,-226,-233,-239,-243,-239,-231)
...
SPActual <- c(df$SPActual,
    ...
    4300,  4346,  4364,  4400,  4391,  4361,  4351,  4364,  4438,  4471)
...
FidVal <- c(df$FidVal,
  ...
  103741,104606,105494,107017,106249,105528,106115,107797,108955,108896) #
Fid <- FidVal / FidIn
Fid <- Fid / Fid[last]
...
f1kIn <- c(df$f1kIn,
   ...
   94678, 94678, 94678, 94678, 94678, 94678, 94678, 94678, 94678, 94678) # 1068.67
f1kVal <- c(df$f1kVal,
  ...
  144835,143452,144586,145654,145654,145283,144466,144867,144867,146606) #
payment <- 1018.67
n <- length(f1kIn)
...
OHIn <- c(df$OHIn,
   ...
   44409, 44409, 44409, 44409, 44409, 44409, 44409, 44409, 44409, 44960) #
OHVal <- c(df$OHVal, 
  ...
  100251, 98751,100042,100617,100976,100558,100098, 98235, 97570, 98119, 99525,
   97796, 98333, 98859, 99830, 99403, 98980, 99465,100560,100942,102256) #
OH <- OHVal / OHIn
OH <- OH / OH[last]
OHd <- dailyChange(OH)
...
# Mon
wil3 <- c(1, 1, 1)
nas3 <- c(1,  0.9998, 0.9995)

# Tue
wil5 <- c(0.9934, 1, 0.9999)
nas5 <- c(1, 1, 1)
...
# Thu
wil20 <- c(0.9922, 0.9928, 0.9999)
nas20 <- c(1, 1, 0.9995)

# Fri
nya35 <- c(1, 0.9998, 0)
nas35 <- c(0.9989, 0.9909, 1)

# Sat
nya50 <- c(1, 1, 1)
nas50 <- c(0.9901, 0.9900, 0.9893)
