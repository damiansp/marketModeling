...
fid.in <- c( 
  ...
  172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,
  172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,172299,
  172299,172299,172299,172299,172299)
fid.val <- c(
  ...
  268940,267282,270667,267286,266100)
...
f1k.in <- c(
  df$f1k.in,            66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   ...
   68225, 68225, 68225, 68225, 68225)  # (1225) 3
f1k.val <- c(
  ...
  124361,124855,124891,128381,128454)  #
...
et.in <- c(
  ...
  103877,103877,103877,103877,103877)  #
et.val <-c(
  ...
  249969,248106,251961,248875,247921)  #
...
# Perf:    1st 2nd 3rd  Pts(2x1x0)  : day 3
# sim1       0   0   4    0
# fid        4   0   0    8
# et         0   4   0    6
