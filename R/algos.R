...
fid.in <- c(
  df$fid.in,      167137,167137,167137,167137,167137,167137,167137,167137,167137,
    ...
    168118,168118,168118,168118,168118) #
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    232492,230514,228486,229981,230323) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     38125, 38125, 38125, 38125, 38125) # (1062.63)
f1k.val <- c(
...
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    182353,180259,177991,177930,178281) #
...
sim1 <- (c(
    ...
    102332,101296,101151,101470,101600)
  / 100000)
sim1.name <- 'adelaide'
...
sim2 <- (c(
    ...
    102491,100794,100195,100399,101222)
  / 100000)
sim2.name <- 'aei'
...
sim3 <- (c(
    ...
    105469,103711,103575,103878,104230)
  / 100000)
sim3.name <- 'simsims'
