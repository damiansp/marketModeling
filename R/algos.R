...
sp.actual <- c(
  df$sp.actual,    3824,  3853,  3808,  3895,  3892,  3919,  3970,  3987,  3999,  
     ...
     4048,  3986,  3992,  3918,  3862,  3856,  3921,  3892,  3960,  3917)
...
fid.in <- c(
  df$fid.in,     161785,161785,161785,161785,161785,161785,161785,162813,162813,
   ...
   165034,165034,165034,165034,165034,165034,165034,165034,165034,165034) #
fid.val <- c(
  df$fid.val,    172350,175073,172978,176119,179159,182181,185241,188878,190980,
   ...
   203729,201713,202164,197271,193099,193960,195970,195308,198412,194950) #
...
f1k.in <- c(
  df$f1k.in,      18031, 18031, 18031, 18031, 18031, 18031, 18031, 18031, 18031,
    ...
    22073, 22073, 22073, 22073, 22073, 22073, 22073, 22073, 22073, 22073) # (1133.49)
f1k.val <- c(
  df$f1k.val,     17787, 17715, 17856, 17766, 18063, 18219, 18434, 18750, 18928,
    ...
    24186, 24111, 23793, 23894, 23410, 23005, 23106, 23414, 23349, 23747) #
...
self.mng.val <- c(
  df$self.mng.val, 9189,  9333,  9243,  9351,  9514,  9655,  9818,  9938, 10033,
    ...
    10293, 10184, 10206,  9936,  9783,  9827,  9875,  9846,  9979,  9841)
...
et.in <- c(
  df$et.in,       76890, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443,
    ...
    78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443,
    78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443,
    78443, 78443, 78443, 78443, 78443, 78443, 78443, 78521, 78521, 78521) #
et.val <-c(
  df$et.val,     123916,128480,126726,128449,130010,131945,134582,135693,137333,
   ...
   145492,143592,143689,140455,138051,138994,140306,140332,141388,139121) #
...
rsi <- (c(
   ...
   105722,101627,100810, 97470, 94960, 96560, 98730, 96746, 97498, 92540)
  / 100000)
...
adl <- (c(
   ...
   104824,101934,101607, 97308, 94338, 96310, 98310, 98382, 98739, 94583)
  / 100000)
