...
sp.actual <- c(
  df$sp.actual,   5827,  5836,  5843,  5950,  5937,  5997,  6049,  6086,  6119,
    ...
    5917,  5958,  5964,  5940,  5845,  5842,  5803)
...
fid.val <- c(
  ...
  273369,274484,274513,274401,271929,272372,271498) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   57760, 57760, 57760, 57760, 57760, 57760, 57760) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   91925, 92182, 92751, 92850, 92520, 92163, 92296) #
...
self.mng.in <- c(
  df$self.mng.in,13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857,
   ...
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835,
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835,
   17835, 17835, 17835, 17835, 17835, 17835, 17835)  #
self.mng.val <- c(
  df$self.mng.val, 
   ...
   23532, 23645, 23628, 23584, 23316, 23407, 23319)  #
...
et.in <- c(
  ...
  101654,101654,101654,101654,101654,101654,101654) #
et.val <-c(
  ...
  235338,236638,236856,236965,234870,235118,234290) #
...
sim1 <- (c(
  ...
  104985,105704,106202,106143,103183,103445,101947)
  / 100000)
sim1.res <- 31209
...
sim2 <- (c(
  ...
  115959,117101,116941,116935,112705,112834,111766)
  / 100000)
sim2.res <- 40286
...
sim3 <- (c(
  ...
  109230,111643,111901,111242,107104,107130,105868)
  / 100000)
sim3.res <- 24461
...
sim4 <- (c(
  ...
  111856,112662,113338,113787,109800,109945,108650)
  / 100000)
sim4.res <- 37549
...
sim5 <- (c(
  ...
  113675,113821,113567,113098,109861,110221,108997)
  / 100000)
sim5.res <- 29099
...
extr <- (c(
  ...
  107274,109215,108780,109492,104964,105386,105430)
  / 100000)
extr.res <- 497
