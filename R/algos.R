...
sp.actual <- c(
  df$sp.actual,   5827,  5836,  5843,  5950,  5937,  5997,  6049,  6086,  6119,
    ...
    5406,  5397,  5276,  5283,  5158,  5288,  5376,  5485,  5525)
...
fid.val <- c(
  ...
  251208,250909,246028,246262,242723,246765,250792,255511,257496) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   57018, 57018, 57018, 57018, 57018, 57018, 57018, 57018, 57018) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   81333, 81939, 81825, 81268, 81290, 79490, 81267, 82751, 84577) #
...
self.mng.in <- c(
  df$self.mng.in,13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857,
   ...
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835,
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835)  #
self.mng.val <- c(
  df$self.mng.val, 
   ...
   21666, 21612, 21313, 21421, 21056, 21420, 21804, 22310, 22421)  #
...
et.in <- c(
  ...
  100912,100912,100912,100912,100912,100912,100912,100912,100912) #
et.val <-c(
  ...
  215922,215335,210983,211269,208168,211803,215335,219756,221733) #
...
sim1 <- (c(
  ...
  106595, 99771,101143, 95632, 95166, 97095, 92383, 93447, 86507, 89072, 93245,
   ...
   85183, 83912, 80515, 80017, 77403, 80511, 83294, 86908, 88464)
  / 100000)
sim1.res <- 22454
...
sim2 <- (c(
  ...
  107459,101726,102048, 95862, 96433, 97906, 91932, 93096, 87305, 90154, 93564,
   ...
   87328, 86915, 82951, 83498, 80618, 84392, 87615, 92325, 94544)
  / 100000)
sim2.res <- 25513
...
sim3 <- (c(
  ...
  107653,100876,101690, 97486, 97629, 99421, 95709, 98280, 93997, 94152, 94379,
   ...
   93797, 93264, 91451, 92699, 89720, 93083, 93341, 96962, 97740)
  / 100000)
sim3.res <- 2477
...
sim4 <- (c(
  ...
  110120,106259,107288,102506,102410,102956, 98081,100882, 94809, 95977, 99419,
   ...
   88252, 87200, 83710, 83422, 80164, 83555, 86316, 91000, 93355)
  / 100000)
sim4.res <- 19561
...
sim5 <- (c(
  ...
  107837,103843,104795, 99577, 99140,101146, 95783, 97220, 91911, 93789, 97338,
   ...
   87459, 87264, 83796, 83634, 80714, 84642, 87635, 92692, 94168)
  / 100000)
sim5.res <- 5496
...
extr <- (c(
  ...
  100231, 94367, 96022, 89898, 88809, 91493, 85395, 88217, 82404, 83606, 86002,
   ...
   75507, 74869, 71099, 71215, 67041, 70824, 74630, 80175, 83495)
  / 100000)
extr.res <- 7039
