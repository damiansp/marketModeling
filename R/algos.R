...
wlsh.osc <- c(
  ...
  -47,-53,-66,-70,-70,-70,-65,-60,-59.355)
...
SPActual <- c(df$SPActual,
    ...
    4374,  4360,  4327,  4258,  4323,  4359,  4367,  4412,  4422,  4401)
...
FidIn <- c(df$FidIn,
   ...
   57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134,
   57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134,
   57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134)
...
FidVal <- c(df$FidVal,
  ...
  109998,109367,109150,109682,111719,112824,112964,114377,113367,111723)
Fid <- FidVal / FidIn
Fid <- Fid / Fid[last]
...
f1kIn <- c(df$f1kIn,
   ...
   90495, 90495, 91204, 91204, 91204, 91204, 91204, 91204, 91204, 91204) #
f1kVal <- c(df$f1kVal,
  ...
  136389,136389,137107,136041,134582,136582,137927,137532,138660,138984)
payment <- 1018.67
n <- length(f1kIn)
...
OHIn <- c(df$OHIn,
   ...
   41554, 41881, 41881, 41881, 41881, 41881, 41881, 41881, 41881, 41881) #
OHVal <- c(df$OHVal, 
  ...
  101622,101246,103242,102694,103325,102648,102961,100355,101452, 87037, 86693,
   ...
   94176, 94520, 94462, 94876, 95998, 96643, 96811, 97876, 96900, 95736) # 
OH <- OHVal / OHIn
OH <- OH / OH[last]
OHd <- dailyChange(OH)
...
# Tue
wil5 <- c(0.9329, 1, 0.9927)
nas5 <- c(1, 1, 1)

# Wed    
wil10 <- c(0.9988, 0.8129, 0)
nas10 <- c(1, 1, 0.9903)

# Thu
wil20 <- c(0.3160, 0.9216, 0.0030)
nas20 <- c(0.9989, 1, 0.9959)

# Fri
nya35 <- c(0.9999, 0.9903, 0)
nas35 <- c(0.9989, 0.9999, 1)

# Sat
nya50 <- c(1, 1, 0.9927)
nas50 <- c(0.9908, 1, 0.9999)
...
(f1k.total <- f1kVal[length(f1kVal)]) # [118811, 138984] [2-param]
