...
sp.actual <- c(
  df$sp.actual,   5827,  5836,  5843,  5950, 5937,  5997,  6049, 6086,  6119,
    ...
    6066,  6069,  6052,  6115,  6115,  6125, 6144)
...
fid.val <- c(
  ...
  268507,268281,268110,270148,268388,269065,268667) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   54794, 54794, 54794, 54794, 54794, 54794, 54794) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   87055, 87728, 87640, 87666, 88496, 88400, 88401) #
...
self.mng.val <- c(
  df$self.mng.val, 
   ...
   18230, 18310, 18420, 18626, 18544, 18695, 18750)  #
...
et.in <- c(
  df$et.in,      92607, 92997, 93120, 93120, 93120, 93120, 93120, 93120, 93120,
   ...
   93330, 93330, 93330, 93474, 93474, 93474, 93474) # 
et.val <-c(
  ...
  217701,217972,217679,219633,217747,216918,216923) #
...
sim1 <- (c(
  ...
  113902,110691,109092,109888,107978,109033,109033)
  / 100000)
sim1.res <- 56602
...
sim2 <- (c(
  ...
  111321,108203,107087,109465,109914,114203,114203)
  / 100000)
sim2.res <- 61486
...
sim3 <- (c(
  ...
  108678,107977,105346,108174,106194,108843,108843)
  / 100000)
sim3.res <- 57262
...
sim4 <- (c(
  ...
  109590,108722,106499,110335,108146,110844,110844)
  / 100000)
sim4.res <- 58353
...
sim5 <- (c(
  ...
  109289,107924,107408,110091,109686,111857,111857)
  / 100000)
sim5.res <- 59107
...
extr <- (c(
  ...
  107160,101994, 99580,101897,102595,111417,111417)
  / 100000)
extr.res <- 9004
