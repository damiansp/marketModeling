...
sp.actual <- c(
  df$sp.actual,          6858,  6902,  6945,  6921,  6921,  6966,  6977,  6964,  
    ...
    6843,  6881,  6862,  6910,  6838,  6890,  6946,  6909,  6879)
...
fid.val <- c(
  ...
  272584,275842,276360,275902,270675,274436,277857,281011,278364)
...
f1k.in <- c(
  df$f1k.in,            66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   ...
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140)  # (1125.13)
f1k.val <- c(
  ...
  117021,117282,118204,117905,118411,116399,117478,118886,118785)  #
...
self.mng.val <- c(
  df$self.mng.val,      35889, 36262, 36552, 36362, 36617, 36757, 36901, 36708, 
   ...
   34597, 34914, 34812, 34743, 33814, 34213, 34634, 35222, 34966)  #
...
et.in <- c(
  ...
  103265,103265,103265,103265,103265,103265,103265,103265,103265)  #
et.val <-c(
  ...
  252319,257070,256679,255732,249176,252428,256149,259610,257446)  #
...
sim1 <- (c(
  ...
  100118, 99925, 99476, 99209, 99429,100134,100957,101784,101118,100535, 98116,
   ...
   94236, 97183, 96263, 95648, 89875, 92382, 95459, 98927, 97075)
  / 100000)
sim1.res <- 7838
...
sim2 <- (c(
  ...
  100237, 99802, 99357, 98890, 99145,100149,100860,101886,101105,100631, 97866,
   ...
   92403, 95410, 94632, 93879, 87782, 90283, 93224, 96608, 95175)
  / 100000)
sim2.res <- 7698
...
sim3 <- (c(
  ...
  100122, 99803, 99289, 98552, 98847,100121,101035,102200,101195,100316, 97071,
   ...
   91237, 93985, 93214, 92248, 85698, 88192, 91330, 94833, 93385)
  / 100000)
sim3.res <- 7883
...
sim4 <- (c(
  ...
  100000,100000,100000,100093,100276,100529,100688,100949,100756,100794,100190,
   ...
   98281, 99647, 99331, 98775, 96419, 96599, 98332,100518,100134)
  / 100000)
sim4.res <- 110852
...
sim5 <- (c(
  ...
  101959,104118,101075, 98816, 96174,102206,104203,103607,102848, 98581,100217,
   99600,101003,100910,102037, 99028,101016,101888,102246,101140)
  / 100000)
sim5.res <- 2417
...
extr <- (c(
  ...
  101135,101125,100388, 98194, 98419,100872,102571,105179,100641, 99465, 92140,
   ...
   71477, 73625, 73031, 71998, 68166, 70822, 73061, 78601, 76595)
  / 100000)
extr.res <- 3634
...
# Perf:    1st 2nd 3rd  Pts(3x2x1)  : weeks 4
# sim1       0   0   3   3
# fid        0   0   1   1
# et         3   1   0  11
# self.mng   1   3   0   9
