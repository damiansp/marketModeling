...
fid.val <- c(
  ...
  281704,282446,274606,274896,265496,272943)
...
f1k.in <- c(
  df$f1k.in,            66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   ...
   66140, 66140, 66140, 66140, 66140, 66140)  # (1125.13)
f1k.val <- c(
  ...
  120799,120044,120361,118705,118326,116458)  #
...
self.mng.in <- c(
  df$self.mng.in,       25017, 25017, 25017, 25017, 25017, 25017, 25017, 25017, 
   ...
   25017, 25017, 25017, 25017, 25017, 25017)  #
self.mng.val <- c(
  df$self.mng.val,      35889, 36262, 36552, 36362, 36617, 36757, 36901, 36708, 
   ...
   35547, 35567, 35031, 35330, 34578, 35416)  #
...
et.in <- c(
  ...
  102870,102893,102893,102893,103066,103066)  #
et.val <-c(
  ...
  263543,262832,258115,257433,248723,255104)  #
...
sim1 <- (c(
  ...
  100118, 99925, 99476, 99209, 99429,100134,100957,101784,101118,100535, 98116,
   97567, 97239, 95624, 97662, 91204, 96099)
  / 100000)
sim1.res <- 19384
...
sim2 <- (c(
  ...
  100237, 99802, 99357, 98890, 99145,100149,100860,101886,101105,100631, 97866,
   97257, 96979, 94514, 95996, 89361, 94158)
  / 100000)
sim2.res <- 22241
...
sim3 <- (c(
  ...
  100122, 99803, 99289, 98552, 98847,100121,101035,102200,101195,100316, 97071,
   96522, 96358, 93428, 95199, 87838, 92684)
  / 100000)
sim3.res <- 7289
...
sim4 <- (c(
  ...
  100000,100000,100000,100093,100276,100529,100688,100949,100756,100794,100190,
   99997, 99757, 99185, 99834, 98299, 99664)
  / 100000)
sim4.res <- 133258
...
sim5 <- (c(
  ...
  101959,104118,101075, 98816, 96174,102206)
  / 100000)
sim5.res <- 9783
...
extr <- (c(
  ...
  101135,101125,100388, 98194, 98419,100872,102571,105179,100641, 99465, 92140,
   89847, 88972, 79927, 81152, 74687, 77002)
  / 100000)
extr.res <- 2542
...
# Perf:    1st 2nd 3rd  Pts(3x2x1)  : weeks 1
# sim1       0   0   1   1
# fid        0   0   0   0
# et         0   1   0   2
# self.mng   1   0   0   3
