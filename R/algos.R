...
# Tue
wil5 <- c(0.9352, 1, 0.9878)
nas5 <- c(1, 1, 1)

# Wed    
wil10 <- c(0.9992, 0.8101, 0)
nas10 <- c(1, 1, 0.9906)

# Thu
wil20 <- c(0.0025, 0.0001, 0.0128)
nas20 <- c(1, 1, 0.9953)

# Fri
nya35 <- c(1, 0.9929, 0)
nas35 <- c(0.9988, 0.9999, 1)

# Sat
nya50 <- c(1, 1, 0.9911)
nas50 <- c(0.9999, 1, 0.0207)
...
(f1k.total <- f1kVal[length(f1kVal)]) # [118811, 137754] [2-param]
