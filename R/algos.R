...
sim2 <- (c(
  ...
  106168,106180,109058,108848,110943,109775)
  / 100000)
sim2.res <- 53666
...
sim3 <- (c(
  ...
  104101,105513,107951,107052,109536,108744)
  / 100000)
sim3.res <- 53549
...
sim4 <- (c(
  ...
  103325,105111,106746,106348,109165,108556)
  / 100000)
sim4.res <- 53464
...
sim5 <- (c(
  ...
  105501,106753,108745,108704,110745,109261)
  / 100000)
sim5.res <- 53898
...
extr <- (c(
   ...
   99729, 99185,101753,100747,103563,101707)
  / 100000)
extr.res <- -1314
