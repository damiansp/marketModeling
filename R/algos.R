...
sp.actual <- c(
  df$sp.actual,          6858,  6902,  6945,  6921,  6921,  6966,  6977,  6964,  
    ...
    6606,  6506,  6581,  6556,  6592,  6477,  6369)
...
fid.val <- c(
  ...
  275068,268822,272997,269350,270644,266568,261832)
...
f1k.in <- c(
  df$f1k.in,            66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   ...
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   66140, 66140, 67541, 68225, 68225, 68225, 68225)  # (1225) 3
f1k.val <- c(
  ...
  117343,117343,119476,121049,120460,121723,119904)  #
...
self.mng.val <- c(
  df$self.mng.val,      35889, 36262, 36552, 36362, 36617, 36757, 36901, 36708, 
   ...
   34947, 34947, 34947, 34947, 34947, 34947, 34947)  #
...
et.in <- c(
  ...
  103325,103877,103877,103877,103877,103877,103877)  #
et.val <-c(
  ...
  253441,249329,253181,249226,250249,246906,241802)  #
...
sim1 <- (c(
  ...
  100447,103075,101470,101236, 97476, 95371, 91073, 90534, 92276, 93431, 90804,
   89674, 86425, 88637, 85643, 86929, 84563, 82061)
  / 100000)
sim1.res <- 1700
...
sim2 <- (c(
  ...
  100237, 99802, 99357, 98890, 99145,100149,100860,101886,101105,100631, 97866,
   ...
   88590, 85597, 87370, 84377, 85266, 82747, 80291)
  / 100000)
sim2.res <- -742
...
sim3 <- (c(
  ...
  100122, 99803, 99289, 98552, 98847,100121,101035,102200,101195,100316, 97071,
   ...
   85648, 82299, 84403, 81029, 82061, 79898, 77615)
  / 100000)
sim3.res <- 859
...
sim4 <- (c(
  ...
  101631,103048,103451,102722,100487, 99349, 97266, 97488, 97739, 98233, 96480,
   94750, 92912, 92805, 89766, 89894, 88207, 86947)
  / 100000)
sim4.res <- 74101
...
sim5 <- (c(
  ...
  101959,104118,101075, 98816, 96174,102206,104203,103607,102848, 98581,100217,
   ...
   89469, 85513, 89009, 88399, 89809, 85599, 82554)
  / 100000)
sim5.res <- -3231
...
extr <- (c(
  ...
  101135,101125,100388, 98194, 98419,100872,102571,105179,100641, 99465, 92140,
   ...
   70039, 67790, 68978, 64001, 63401, 63286, 60382)
  / 100000)
extr.res <- -918
