...
wlsh.osc <- c(
  ...
  -47,-52,-61,-66,-70,-79,-95,-111,-121,-124,-127)
...
FidVal <- c(df$FidVal,
  ...
  111560,109341,109730,110508,111222,110470) #
Fid <- FidVal / FidIn
Fid <- Fid / Fid[last]
...
f1kIn <- c(df$f1kIn,
   ...
   93978, 93978, 93978, 93978, 93978, 93978) #
f1kVal <- c(df$f1kVal,
  ...
  145828,144829,142661,142678,145490,145490) #
payment <- 1018.67
n <- length(f1kIn)
...
OHIn <- c(df$OHIn,
   ...
   43474, 43474, 43828, 43828, 43828, 43828) #
OHVal <- c(df$OHVal, 
  ...
  100251, 98751,100042,100617,100976,100558) #
OH <- OHVal / OHIn
OH <- OH / OH[last]
OHd <- dailyChange(OH)
...
m1 <- (c(
  ...
  117336,110919,108642,108221,101922,104631,106850,105531, 98774, 94278, 93620,
   ...
   99199, 99580, 97763, 98533, 99415,100151, 99769)
  / 100000)
qp.start <- 92
m1.name <- 'BuyNHold'
...
m2 <- (c(
  ...
  105412,106112,103465,103717,104424,104798,104260)
  / 100000) 
...
m3.raw <- c(
  ...
  104229,105445,102390,102525,103562,104492,103430)
m3 <- m3.raw / 100000
m3.name <- 'CashInLow'
#len <- length(m3)
...
m4.raw <- c(
  ...
  102214,102471,100271,101051,102292,104492,102877)
m4 <- m4.raw / 100000
m4.name <- 'CashInHigh'
len <- length(m4)
...
m5 <- (c(
  ...
  106162,107069,104362,104519,105304,105942,105247)
  / 100000)
m5.name <- '30/70'  
...
m6 <- (c(
  ...
  108929,109720,107564,108570,109675,110538,109903)
  / 100000)
m6.name <- 'rsi each'  
...
m7 <- (c(
  ...
  101184,101512, 99705,100438,101146,101832,101286)
  / 100000)
m7.name <- 'rsi overall'  
...
# Mon
wil3 <- c(1, 1, 1)
nas3 <- c(0.9804, 0.9999, 0.8508)

# Tue
wil5 <- c(0.9868, 1, 0.9934)
nas5 <- c(1, 1, 1)

# Wed    
wil10 <- c(0.0100, 1, 0.0102)
nas10 <- c(1, 1, 0.9999)

# Thu
wil20 <- c(0.0222, 0.7609, 0.9902)
nas20 <- c(1, 1, 0.9964)

# Fri
nya35 <- c(1, 0.9888, 0)
nas35 <- c(0.9989, 0.9904, 1)

# Sat
nya50 <- c(1, 1, 1)
nas50 <- c(1, 0.0102, 0.9910)
