...
wlsh.osc <- c(
  ...
  -52,-50,-48,-47,-51,-59,-67,-71,-70,-67,-64,-65,-60,-51,-47,-42,-38)
...
m1 <- (c(
  ...
  117336,110919,108642,108221,101922,104631,106850,105531, 98774, 94278, 93620,
   ...
   98093, 98299, 99140, 99848,101014)
  / 100000)
qp.start <- 92
m1.name <- 'BuyNHold'
...
m2 <- (c(
  ...
  106966,106520,108051,107668,108095)
  / 100000) 
...
m3.raw <- c(
  ...
  105487,105340,107042,107443,107928)
m3 <- m3.raw / 100000
m3.name <- 'CashInLow'
#len <- length(m3)
...
m4.raw <- c(
  ...
  101283,101490,102260,102439,104144)
m4 <- m4.raw / 100000
m4.name <- 'CashInHigh'
len <- length(m4)
...
m5 <- (c(
  ...
  105363,105457,106680,107205,108625)
  / 100000)
m5.name <- '30/70'  
...
m6 <- (c(
  ...
  108285,109107,109680,110727,111329)
  / 100000)
m6.name <- 'rsi each'  
...
m7 <- (c(
  ...
  100999,100935,101636,101615,102230)
  / 100000)
m7.name <- 'rsi overall'  
...
# Mon
wil3 <- c(1, 1 , 0.9999)
nas3 <- c(1, 0.9999, 0.9864)

# Tue
wil5 <- c(0.9971, 1, 0.9935)
nas5 <- c(1, 1, 0.9443)

# Wed    
wil10 <- c(1, 0.9999, 0.9513)
nas10 <- c(1, 1, 0.0103)

# Thu
wil20 <- c(0.8863, 0.0146, 0.0001)
nas20 <- c(1, 1, 0.9961)

# Fri
nya35 <- c(1, 0.9852, 0.0109)
nas35 <- c(0.9989, 1, 1)
