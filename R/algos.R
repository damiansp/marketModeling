...
wlsh.osc <- c(
  ...
  -52,-50,-48,-47,-51,-59,-67,-71,-70,-67,-64,-65,-60)
...
# Mon
wil3 <- c(1, 1 , 0.9999)
nas3 <- c(1, 0.9999, 0.9862)

# Tue
wil5 <- c(0.9971, 1, 0.9934)
nas5 <- c(0.9999, 0.9999, 0.9435)

# Wed    
wil10 <- c(1, 0.9999, 0.9934)
nas10 <- c(1, 1, 0.0099)
...
(f1k.total <- f1kVal[length(f1kVal)]) # [118811, 144038] [2-param]
