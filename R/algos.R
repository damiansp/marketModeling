...
sp.actual <- c(
  df$sp.actual,    3824,  3853,  3808,  3895,  3892,  3919,  3970,  3987,  3999,  
     ...
     4138,  4119,  4138,  4131,  4124,  4136,  4110,  4158,  4198,  4192)
...
fid.in <- c(
  df$fid.in,     161785,161785,161785,161785,161785,161785,161785,162813,162813,
   ...
   166251,166251,166251,166251,166251,166703,166703,166703,166703,166703) #
fid.val <- c(
  df$fid.val,    172350,175073,172978,176119,179159,182181,185241,188878,190980,
   ...
   204211,204354,205736,205739,204976,206813,205499,206832,207400,206952) #
...
f1k.in <- c(
  df$f1k.in,      18031, 18031, 18031, 18031, 18031, 18031, 18031, 18031, 18031,
    ...
    26118, 26118, 26118, 26118, 26118, 26118, 26118, 26118, 27114, 27114) # (1133.49)
f1k.val <- c(
  df$f1k.val,     17787, 17715, 17856, 17766, 18063, 18219, 18434, 18750, 18928,
    ...
    29594, 29675, 29620, 29813, 29814, 29691, 29856, 29735, 31139, 31503) #
...
self.mng.val <- c(
  df$self.mng.val, 9189,  9333,  9243,  9351,  9514,  9655,  9818,  9938, 10033,
    ...
    10342, 10331, 10337, 10358, 10266, 10330, 10265, 10313, 10377, 10327)
...
et.in <- c(
  df$et.in,       76890, 78443, 78443, 78443, 78443, 78443, 78443, 78443, 78443,
    ...
    78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521,
    78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521,
    78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521, 78521) #
et.val <-c(
  df$et.val,     123916,128480,126726,128449,130010,131945,134582,135693,137333,
   ...
   148289,148454,149747,150115,148980,150632,149726,150106,150334,150271) #
...
rsi <- (c(
   ...
   100974,100887,106069,106992,105957,109161,106651,109158,111747,110963)
  / 100000)
...
adl <- (c(
   ...
   104824,101934,101607, 97308, 94338, 96310, 98310, 98382, 98739, 94583, 94447,
    ...
    94573, 94722, 95343, 96514, 95525, 96691, 94865, 95457, 96726, 96679)
  / 100000)
...
(f1k.total <- f1k.val[length(f1k.val)])              # [ 18063  31139] 
