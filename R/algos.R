...
sp.actual <- c(
  df$sp.actual,     4743,  4705,  4689,  4697,  4764,  4757,  4783,  4780,  4784,
      ...
      5006,  4976,  4982,  5087,  5089,  5070,  5078,  5070,  5096,  5137)
...
fid.in <- c(
  df$fid.in,      167137,167137,167137,167137,167137,167137,167137,167137,167137,
    ...
    168118,168118,168118,168118,168118,168118,168118,168659,168659,168659) #
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    232492,230514,228486,229981,230323,230887,232613,232499,233201,234712) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     38125, 38125, 38125, 38125, 38125, 38125, 38125, 38125, 38125, 38125) # (1062.63)
f1k.val <- c(
  df$f1k.val,      48986, 48283, 47658, 47523, 47500, 48441, 48481, 48834, 48889,
     ...
     52829, 52634, 52248, 52172, 53963, 53967, 53910, 54156, 53976, 54138) #
...
self.mng.val <- c(
  df$self.mng.val, 16169, 15852, 15887, 15861, 16152, 16065, 16106, 16048, 15949,
     ...
     16157, 15990, 15865, 15916, 15896, 15920, 16087, 15971, 15955, 16085)  #
...
et.in <- c(
  df$et.in,        86278, 86278, 86278, 86278, 86278, 86278, 86278, 86278, 86588,
     ...
     86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588,
     86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588) #
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    182353,180259,177991,177930,178281,178744,181243,180251,180780,181437) #
...
sim1 <- (c(
    ...
    102332,101296,101151,101470,101600,102357,102763,102291,102912,103426)
  / 100000)
sim1.name <- 'adelaide'
...
sim2 <- (c(
    ...
    102491,100794,100195,100399,101222,102244,102900,102483,103478,104332)
  / 100000)
sim2.name <- 'aei'
...
sim3 <- (c(
    ...
    105469,103711,103575,103878,104230,105505,106520,106100,106887,107357)
  / 100000)
sim3.name <- 'simsims'
