...
fid.in <- c(
  df$fid.in,      167137,167137,167137,167137,167137,167137,167137,167137,167137,
    ...
    167743,167743,167743,167743,167743) #
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    226581,228977,229117,227482,230179) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     37344, 37344, 37344, 37344, 37344) # (1062.63)
f1k.val <- c(
...
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    178873,179782,180339,178199,180807) #
...
sim1 <- (c(
    ...
    100108,100333,100273, 99800,101074)
  / 100000)
sim1.name <- 'adelaide'
...
sim2 <- (c(
    ...
    100206,100550,100560,100109,101389)
  / 100000)
sim2.name <- 'aei'
...
sim3 <- (c(
    ...
    100374,100335,100273,100497,100651,100707,100672,100509,100488,100950,100587,
     99954,100323,100221, 99203,101861)
  / 100000)
sim3.name <- 'simsims'
