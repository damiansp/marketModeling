...
wlsh.osc <- c(
  ...
  -47,-52,-61,-66,-70,-79,-95,-111,-121,-124,-127,-131,-145,-158,-175,-185)
...
f1kIn <- c(df$f1kIn,
   ...
   93978, 93978, 93978, 93978, 93978, 93978, 93978, 93978, 93978, 93978, 94678) #
f1kVal <- c(df$f1kVal,
...
# Mon
wil3 <- c(1, 1, 1)
nas3 <- c(0.9798,  0.9999, 0.9877)

# Tue
wil5 <- c(0.9932, 1, 0.9999)
nas5 <- c(1, 1, 1)

# Wed    
wil10 <- c(0.9901, 1, 0.9902)
nas10 <- c(1, 1, 0.9999)

# Thu
wil20 <- c(0.0835, 1, 0.9999)
nas20 <- c(1, 1, 0.9962)

# Fri
nya35 <- c(1, 0.9998, 0)
nas35 <- c(0.9988, 0.0384, 1)

# Sat
nya50 <- c(1, 1, 1)
nas50 <- c(1, 0.0001, 0.0823)
