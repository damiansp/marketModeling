...
SPActual <- c(df$SPActual,
  ...
  4394,4272,4296,4175,4184,4288,4132,4155,4175,4300,4147,4123)
...
FidVal <- c(df$FidVal,
  ...
  217134,211660,210306,213446,208981,212931,212020,216771,207224,202355) #
Fid <- FidVal / FidIn
Fid <- Fid / Fid[last]
...
f1kIn <- c(df$f1kIn,
  ...
  0.6935,0.6935,0.6935,0.6935,0.6935,0.6935,0.6935,0.6935,0.6935,0.6935,0.6935,
    ...
    3375,  3375,  3375,  3375,  3375,  3375,  3375,  3375,  4129,  4129) # 961.47
f1kVal <- c(df$f1kVal,
  ...
  147813,146496,145095,141741,141741,141741,     1,     1,     1,     1,     1,
    ...
    4455,  4511,  4342,  4349,  4474,  4276,  4319,  4301,  5377,  5117) #
n <- length(f1kIn)
...
OHIn <- c(df$OHIn,
    ...
    60643, 60643, 61614, 61614, 61614, 62294, 62294, 62294, 62294, 62294) # 917 + 253
OHVal <-c(df$OHVal,    
   ...
   117227,114478,116299,117700,115609,117580,116664,118435,114622,111952) #
OH <- OHVal / OHIn
OH <- OH / OH[last]
OHd <- dailyChange(OH)
...
(f1k.total <- f1kVal[length(f1kVal)]) # [  847,   5377] [2-param]
