...
fid.val <- c(
  ...
  254475,254696,256898,259615,247740,235096) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   56261, 56261, 56261, 56261, 57018, 57018) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   84878, 83133, 83241, 83671, 85478, 81210) #
...
self.mng.val <- c(
  df$self.mng.val, 
   ...
   22134, 22032, 22171, 22506, 21255, 20404)  #
...
et.in <- c(
  df$et.in,      92607, 92997, 93120, 93120, 93120, 93120, 93120, 93120, 93120,
   ...
   96450, 96450, 96450, 96450, 98251,100213) #
et.val <-c(
  ...
  208292,208411,211009,213769,202953,199460) #
...
sim1 <- (c(
  ...
  106595, 99771,101143, 95632, 95166, 97095, 92383, 93447, 86507, 89072, 93245,
   ...
   93529, 93442, 94987, 96996, 84851, 74901)
  / 100000)
sim1.res <- -196
...
sim2 <- (c(
  ...
  107459,101726,102048, 95862, 96433, 97906, 91932, 93096, 87305, 90154, 93564,
   ...
   93091, 92681, 94614, 97022, 84129, 74476)
  / 100000)
sim2.res <- 1518
...
sim3 <- (c(
  ...
  107653,100876,101690, 97486, 97629, 99421, 95709, 98280, 93997, 94152, 94379,
   ...
   94667, 97075, 97355, 99442, 95553, 86233)
  / 100000)
sim3.res <- -4221
...
sim4 <- (c(
  ...
  110120,106259,107288,102506,102410,102956, 98081,100882, 94809, 95977, 99419,
   ...
   95433, 95495, 97685, 99853, 85487, 75022)
  / 100000)
sim4.res <- 7133
...
sim5 <- (c(
  ...
  107837,103843,104795, 99577, 99140,101146, 95783, 97220, 91911, 93789, 97338,
   ...
   96663, 96570, 98145,100981, 87656, 76843)
  / 100000)
sim5.res <- -7335
...
extr <- (c(
  ...
  100231, 94367, 96022, 89898, 88809, 91493, 85395, 88217, 82404, 83606, 86002,
   ...
   83953, 82181, 84059, 87958, 74659, 67133)
  / 100000)
extr.res <- -7450
