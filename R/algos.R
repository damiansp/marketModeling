...
sp.actual <- c(
  df$sp.actual,     4743,  4705,  4689,  4697,  4764,  4757,  4783,  4780,  4784,
      ...
      5225,  5242,  5234,  5218,  5204,  5248,  5254)
...
fid.in <- c(
  df$fid.in,      167137,167137,167137,167137,167137,167137,167137,167137,167137,
    ...
    169043,169043,169043,169043,169043,169043,169043) #
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    234789,234401,233398,233032,232857,234877,235694) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     39644, 40401, 40401, 40401, 40401, 40401, 40401) # (1062.63)
f1k.val <- c(
  df$f1k.val,      48986, 48283, 47658, 47523, 47500, 48441, 48481, 48834, 48889,
     ...
     55642, 57178, 57367, 57156, 57078, 56963, 57499) #
...
self.mng.val <- c(
  df$self.mng.val, 16169, 15852, 15887, 15861, 16152, 16065, 16106, 16048, 15949,
     ...
     15997, 15993, 15896, 15924, 15877, 16054, 16109)  #
...
et.in <- c(
  df$et.in,        86278, 86278, 86278, 86278, 86278, 86278, 86278, 86278, 86588,
     ...
     86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588,
     86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588, 86588,
     86588, 86588, 86588, 86588, 86588, 86588, 86588) #
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    182342,181731,180843,180198,180135,182084,182768) #
...
sim1 <- (c(
    ...
    103257,102868,102540,102360,102660,103013,103286)
  / 100000)
sim1.name <- 'adelaide'
...
sim2 <- (c(
    ...
    103814,103012,102045,101976,102074,103215,103715)
  / 100000)
sim2.name <- 'aei'
...
sim3 <- (c(
    ...
    106709,106494,105736,105307,105491,106508,107811)
  / 100000)
sim3.name <- 'simsims'
