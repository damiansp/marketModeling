...
sp.actual <- c(
  df$sp.actual,   5827,  5836,  5843,  5950,  5937,  5997,  6049,  6086,  6119,
    ...
    5569,  5625,  5687,  5650,  5607,  5631,  5664,  5660)
...
fid.val <- c(
  ...
  259119,259728,262891,262544,261711,262288,263646,263556) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   57018, 57018, 57018, 57018, 57018, 57018, 57760, 57760) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   85632, 85669, 86207, 87403, 87011, 86420, 87710, 88356) #
...
self.mng.in <- c(
  df$self.mng.in,13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857,
   ...
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835,
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835,
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835)  #
self.mng.val <- c(
  df$self.mng.val, 
   ...
   22435, 22534, 22791, 22735, 22597, 22582, 22825, 22790)  #
...
et.in <- c(
  ...
  101315,101315,101315,101315,101315,101315,101315,101315) #
et.val <-c(
  ...
  223956,224161,227143,226662,225667,225822,226709,226374) #
...
sim1 <- (c(
  ...
  106595, 99771,101143, 95632, 95166, 97095, 92383, 93447, 86507, 89072, 93245,
   ...
   91242, 91113, 94887, 94623, 93567, 93235, 94706, 95794)
  / 100000)
sim1.res <- 17025
...
sim2 <- (c(
  ...
  107459,101726,102048, 95862, 96433, 97906, 91932, 93096, 87305, 90154, 93564,
   ...
   98225, 98350,102945,102364,101661,101666,103959,104647)
  / 100000)
sim2.res <- 11899
...
sim3 <- (c(
  ...
  100247, 99391,103081,102724, 98608, 98392,101296,100486)
  / 100000)
sim3.res <- 368
...
sim4 <- (c(
  ...
  110120,106259,107288,102506,102410,102956, 98081,100882, 94809, 95977, 99419,
   ...
   95115, 95501, 99247, 99024, 97916, 97471, 99893,101872)
  / 100000)
sim4.res <- 21687
...
sim5 <- (c(
  ...
  107837,103843,104795, 99577, 99140,101146, 95783, 97220, 91911, 93789, 97338,
   ...
   98656, 99445,102498,102002,100908,101288,103422,103946)
  / 100000)
sim5.res <- 13974
...
extr <- (c(
  ...
  100231, 94367, 96022, 89898, 88809, 91493, 85395, 88217, 82404, 83606, 86002,
   ...
   85832, 88646, 91965, 91235, 90259, 90208, 92495, 92005)
  / 100000)
extr.res <- -426
