...
sp.actual <- c(
  df$sp.actual,     4743,  4705,  4689,  4697,  4764,  4757,  4783,  4780,  4784,
      ...
      5478,  5483,  5460,  5475,  5509,  5537,  5567)
...
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    232366,233366,233117,232227,230614,231987,231919) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     44950, 44950, 44950, 44950, 44950, 44950, 45676) # (1062.63)
f1k.val <- c(
  df$f1k.val,      48986, 48283, 47658, 47523, 47500, 48441, 48481, 48834, 48889,
     ...
     65200, 65382, 65531, 65306, 65381, 65768, 67135) #
...
self.mng.val <- c(
  df$self.mng.val, 16169, 15852, 15887, 15861, 16152, 16065, 16106, 16048, 15949,
     ...
     15865, 15948, 15876, 15854, 15957, 16014, 16002)  #
...
et.in <- c(
  df$et.in,        86278, 86278, 86278, 86278, 86278, 86278, 86278, 86278, 86588,
     ...
     88109, 88630, 88630, 88630, 88630, 88630, 88630) #
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    171561,174805,174790,174299,174766,175089,176173) #
...
sim1 <- (c(
    ...
    102270,103837,104391,104463,104000,104561,104487)
  / 100000)
sim1.res <- 1587
...
sim2 <- (c(
    ...
    103812,106750,107380,107106,106548,107482,107795)
  / 100000)
sim2.res <- 2400
...
sim3 <- (c(
    ...
    106646,108907,108579,108509,107591,108200,108420)
  / 100000)
sim3.res <- 4011
...
sim4 <- (c(
     ...
     99085, 99915, 98831, 98265, 99776,100092,101516)
  / 100000)
sim4.res <- 2950
...
sim5 <- (c(
    ...
    101717,104187,104871,101874,100974,100786,101049)
  / 100000)
sim5.res <- 3497
...
legend(
  ...
  col=c(
    ...
    'hotpink', 'limegreen', 'cyan', 'burlywood4', 'coral', 'red'),
  legend=c(
    paste(sp.sh, 'S&P'),
    paste(fid.sh, 'Fid'),
    paste(et.sh, 'ETrade'),
