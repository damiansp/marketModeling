...
fid.val <- c(
  df$fid.val,     226255,222123,222288,222370,226164,226085,226787,226918,226111,
    ...
    233689,231503,233423,227740,227824) #
...
f1k.in <- c(
  df$f1k.in,       36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528, 36528,
     ...
     44218, 44218, 44218, 44218, 44218) # (1062.63)
f1k.val <- c(
...
et.val <-c(
  df$et.val,      182169,178447,178828,178839,181753,181913,181774,181776,181803,
    ...
    172757,172701,173560,170635,170735) #
...
sim1 <- (c(
    ...
    101520,102060,101842, 99875,100216)
  / 100000)
sim1.res <- 98
...
sim2 <- (c(
    ...
    100833,101781,102773, 99428,100766)
  / 100000)
sim2.res <- 4265
...
sim3 <- (c(
    ...
    103812,105130,105306,102299,102601)
  / 100000)
sim3.res <- 15693
