...
wlsh.osc <- c(
  ...
  -47,-53,-66,-70,-70,-70,-65,-60,-59,-58,-55,-56,-58,-57,-59,-57,-55.189)
...
SPActual <- c(df$SPActual,
    ...
    4419,  4395,  4387,  4423,  4403,  4429,  4437)
...
FidIn <- c(df$FidIn,
   ...
   57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134,
   57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134, 57134,
   57134, 57134, 57134, 57134, 57134, 57134, 57134)
...
FidVal <- c(df$FidVal,
  ...
  113115,111155,111815,111618,112371,112921,111060)
Fid <- FidVal / FidIn
Fid <- Fid / Fid[last]
...
f1kIn <- c(df$f1kIn,
   ...
   91204, 91204, 91903, 91903, 91903, 91903, 91903) #
f1kVal <- c(df$f1kVal,
  ...
  138816,139344,139871,139474,140518,140820,140820) #
payment <- 1018.67
n <- length(f1kIn)
...
OHIn <- c(df$OHIn,
   ...
   41881, 42208, 42208, 42208, 42208, 42208, 42208) #
OHVal <- c(df$OHVal, 
  ...
  101622,101246,103242,102694,103325,102648,102961,100355,101452, 87037, 86693,
   ...
   96802, 96111, 96316, 95859, 96304, 96559, 95474) # 
OH <- OHVal / OHIn
OH <- OH / OH[last]
OHd <- dailyChange(OH)
...
m1 <- (c(
  ...
  117336,110919,108642,108221,101922,104631,106850,105531, 98774, 94278, 93620,
   ...
   97271, 96977, 96330, 96820, 96124, 96868, 97989, 96553)
  / 100000)
qp.start <- 92
m1.name <- 'BuyNHold'
...
m2 <- (c(
  ...
  108101,107192,105148,105701,105297,106108,106936,104858)
  / 100000) 
...
m3.raw <- c(
  ...
  107063,106020,104252,104268,104076,104583,105992,103781)
m3 <- m3.raw / 100000
m3.name <- 'CashInLow'
#len <- length(m3)
...
m4.raw <- c(
  ...
  102095,101168, 99047, 99236, 99148,100697,101348, 99578)
m4 <- m4.raw / 100000
m4.name <- 'CashInHigh'
len <- length(m4)
...
m5 <- (c(
  ...
  106989,105936,103692,103841,103520,104474,104989,102845)
  / 100000)
m5.name <- '30/70'  
...
m6 <- (c(
  ...
  102649,102062,100163,100630,100571,101452,103568,102077)
  / 100000)
m6.name <- 'rsi each'  
...
m7 <- (c(
  ...
  101713,101119, 99593,100166, 99788,100408,101420,100124)
  / 100000)
m7.name <- 'rsi overall'  
...
# Tue
wil5 <- c(0.9999, 1, 0.9948)
nas5 <- c(1, 1, 0.9424)

# Wed    
wil10 <- c(0.0075, 0.8432, 0.9819)
nas10 <- c(1, 1, 0.0100)

# Thu
wil20 <- c(0, 0.0001, 0.0009)
nas20 <- c(1, 1, 0.9959)

# Fri
nya35 <- c(1, 0.9904, 0.9911)
...
(f1k.total <- f1kVal[length(f1kVal)]) # [118811, 140820] [2-param]
