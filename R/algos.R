...
sp.actual <- c(
  df$sp.actual,   5827,  5836,  5843,  5950,  5937,  5997,  6049,  6086,  6119,
    ...
    5983,  5981,  5968,  6025,  6092,  6092,  6141,  6173)
...
fid.val <- c(
  ...
  275923,275483,275031,277021,279283,278082,278870,280200) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   58451, 58451, 58451, 58451, 58451, 58451, 58451, 58451) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   96276, 95510, 96545, 96283, 97179, 98345, 98224, 98905) #
...
self.mng.val <- c(
  df$self.mng.val, 
   ...
   23690, 23761, 23739, 23956, 24222, 24051, 24147, 24272)  #
...
et.in <- c(
  ...
  101985, 97875, 97875, 97875, 97875, 97875, 97875, 98410) #
et.val <-c(
  ...
  238466,228618,228464,229906,231427,230224,230657,232784) #
...
sim1 <- (c(
  ...
  102062,102399,103549,105966,109236,106811,108164,109202)
  / 100000)
sim1.res <- 49269
...
sim2 <- (c(
  ...
  111009,112497,113782,115911,119583,117897,120217,121262)
  / 100000)
sim2.res <- 1487
...
sim3 <- (c(
  ...
  107192,106963,105381,107923,112321,111646,113205,113365)
  / 100000)
sim3.res <- 19050
...
sim4 <- (c(
  ...
  109715,110193,111158,114256,117062,115151,116739,117389)
  / 100000)
sim4.res <- 56999
...
sim5 <- (c(
  ...
  108168,109232,109104,111784,115484,112710,114938,115937)
  / 100000)
sim5.res <- 5697
...
extr <- (c(
  ...
  119880,119597,118033,123707,125803,125769,127907,129224)
  / 100000)
extr.res <- 3062
