...
FidVal <- c(df$FidVal,
  ...
  103741,104606,105494,107017,106249) #
Fid <- FidVal / FidIn
Fid <- Fid / Fid[last]
...
f1kVal <- c(df$f1kVal,
  ...
  144835,143452,144586,145654,145654) #
payment <- 1018.67
n <- length(f1kIn)
...
m1 <- (c(
  ...
  117336,110919,108642,108221,101922,104631,106850,105531, 98774, 94278, 93620,
   ...
   94989, 95132, 92906, 93639, 95246, 94577)
  / 100000)
qp.start <- 92
m1.name <- 'BuyNHold'
...
m2 <- (c(
  ...
  100392, 97160, 97512, 97737, 98723, 98693)
  / 100000) 
...
m3.raw <- c(
  ...
  104229,105445,102390,102525,103562,104492,103430,102844, 99070, 97237, 98180,
   98179, 94238, 95364, 96441, 98518, 97377)
m3 <- m3.raw / 100000
m3.name <- 'CashInLow'
#len <- length(m3)
...
m4.raw <- c(
  ...
  102214,102471,100271,101051,102292,104492,102877,100966, 96929, 96076, 96778,
   96845,100341, 94596, 95717, 97265, 95871)
m4 <- m4.raw / 100000
m4.name <- 'CashInHigh'
len <- length(m4)
...
m5 <- (c(
  ...
  101107, 97628, 98748, 99859,101812,100670)
  / 100000)
m5.name <- '30/70'  
...
m6 <- (c(
  ...
  105377,100788,101503,102354,104140,102784)
  / 100000)
m6.name <- 'rsi each'  
...
m7 <- (c(
  ...
  101184,101512, 99705,100438,101146,101832,101286,100625, 97889, 96975, 97630,
   97741, 96054, 95547, 96477, 97787, 97068)
  / 100000)
m7.name <- 'rsi overall'  
...
# Mon
wil3 <- c(1, 1, 1)
nas3 <- c(0.9798,  0.9998, 0.9995)

# Tue
wil5 <- c(0.9933, 1, 0.9999)
nas5 <- c(1, 1, 1)

# Wed    
wil10 <- c(0.9999, 1, 0.9999)
nas10 <- c(1, 1, 0.9999)

# Thu
wil20 <- c(0.0840, 0.9926, 0.9999)
nas20 <- c(1, 1, 0.9978)

# Fri
nya35 <- c(1, 0.9998, 0)
nas35 <- c(0.9988, 0.0385, 1)

# Sat
nya50 <- c(1, 1, 1)
nas50 <- c(0.0102, 0.0001, 0.0824)
