...
sp.actual <- c(
  df$sp.actual,   5827,  5836,  5843,  5950,  5937,  5997,  6049, 6086,  6119,
    ...
    5522,  5639,  5675,  5615,  5675,  5663,  5668)
...
fid.val <- c(
  ...
  247741,254830,256844,252872,256130,254530,255483) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   55489, 55489, 56261, 56261, 56261, 56261, 56261) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   82429, 80876, 82952, 83761, 82618, 84794, 84480) #
...
self.mng.val <- c(
  df$self.mng.val, 
   ...
   21613, 22269, 22704, 22274, 22682, 22508, 22536)  #
...
et.in <- c(
  df$et.in,      92607, 92997, 93120, 93120, 93120, 93120, 93120, 93120, 93120,
   ...
   95937, 95937, 95937, 95937, 95937, 95937, 95937) #
et.val <-c(
  ...
  205102,211458,212928,208711,211230,209235,209926) #
...
sim1 <- (c(
  ...
  106595, 99771,101143, 95632, 95166, 97095, 92383, 93447, 86507, 89072, 93245,
   87294, 92401, 94503, 90356, 94051, 92502, 94408)
  / 100000)
sim1.res <- 9352
...
sim2 <- (c(
  ...
  107459,101726,102048, 95862, 96433, 97906, 91932, 93096, 87305, 90154, 93564,
   87291, 93629, 96691, 91832, 95760, 93989, 96026)
  / 100000)
sim2.res <- 3950
...
sim3 <- (c(
  ...
  107653,100876,101690, 97486, 97629, 99421, 95709, 98280, 93997, 94152, 94379,
   90535, 94619, 98534, 97148, 99559, 96462, 96604)
  / 100000)
sim3.res <- 6605
...
sim4 <- (c(
  ...
  110120,106259,107288,102506,102410,102956, 98081,100882, 94809, 95977, 99419,
   92178, 97754, 99753, 95185, 98773, 96755, 98748)
  / 100000)
sim4.res <- 8009
...
sim5 <- (c(
  ...
  107837,103843,104795, 99577, 99140,101146, 95783, 97220, 91911, 93789, 97338,
   91695, 98056,101523, 96790,100652, 98850,100448)
  / 100000)
sim5.res <- 5390
...
extr <- (c(
  ...
  100231, 94367, 96022, 89898, 88809, 91493, 85395, 88217, 82404, 83606, 86002,
   83217, 88937, 89904, 86645, 89867, 88796, 89465)
  / 100000)
extr.res <- 1992
