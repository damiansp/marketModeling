...
fid.val <- c(
  ...
  284286,282133,283039,284051,284559,283042) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   59110, 59110, 59110, 59110, 59110, 59110) # (1125.13)
f1k.val <- c(
  ...
  101506,102360,101638,101578,102137,102181) #
...
self.mng.in <- c(
  df$self.mng.in,13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857, 13857,
   ...
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835,
   17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835, 17835,
   17835, 25017, 25017, 25017, 25017, 25017)  # 
self.mng.val <- c(
  df$self.mng.val, 
   ...
   24833, 34677, 34735, 34826, 34815, 34590)  #
...
et.in <- c(
  ...
  101985, 97875, 97875, 97875, 97875, 97875, 97875, 98410, 98410, 98410, 98410,
   98410, 98410, 98410, 98410, 98410, 98410) # +515
et.val <-c(
  ...
  235573,233350,234202,234874,236231,235141) #
...
sim1 <- (c(
  ...
  114173,111960,112125,113282,113496,111768)
  / 100000)
sim1.res <- 39723
...
sim2 <- (c(
  ...
  128053,125439,125445,125810,126303,124161)
  / 100000)
sim2.res <- 8789
...
sim3 <- (c(
  ...
  117121,115389,115254,116966,116441,114127)
  / 100000)
sim3.res <- 7943
...
sim4 <- (c(
  ...
  122386,119912,120107,121527,121610,120072)
  / 100000)
sim4.res <- 34920
...
sim5 <- (c(
  ...
  122511,120523,121137,121691,121294,118962)
  / 100000)
sim5.res <- 1527
...
extr <- (c(
  ...
  136609,131509,131112,132876,131862,129566)
  / 100000)
extr.res <- -2261
