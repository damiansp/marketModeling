...
sp.actual <- c(
  df$sp.actual,          6858,  6902,  6945,  6921,  6921,  6966,  6977,  6964,  
    ...
    6870,  6831,  6740,  6796,  6781,  6776,  6673,  6632)
...
fid.val <- c(
  ...
  281437,282017,279815,282263,280666,281493,278954,275939)
...
f1k.in <- c(
  df$f1k.in,            66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   ...
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140)  # ($$??)
f1k.val <- c(
  ...
  117278,118432,118269,116849,117640,117343,117343,117343)  #
...
self.mng.val <- c(
  df$self.mng.val,      35889, 36262, 36552, 36362, 36617, 36757, 36901, 36708, 
   ...
   35355, 35526, 35208, 35077, 34947, 34947, 34947, 34947)  #
...
et.in <- c(
  ...
  103265,103265,103265,103265,103265,103265,103265,103265)  # +147
et.val <-c(
  ...
  260355,261669,259731,260578,258611,259504,256037,254471)  #
...
sim1 <- (c(
  ...
  100447,103075,101470,101236, 97476, 95371, 91073, 90534)
  / 100000)
sim1.res <- 4619
...
sim2 <- (c(
  ...
  100237, 99802, 99357, 98890, 99145,100149,100860,101886,101105,100631, 97866,
   ...
   98649,101582, 99458, 99110, 95824, 93865, 89214, 89242)
  / 100000)
sim2.res <- 4820
...
sim3 <- (c(
  ...
  100122, 99803, 99289, 98552, 98847,100121,101035,102200,101195,100316, 97071,
   ...
   96781, 99838, 98013, 97408, 93646, 91440, 87138, 87148)
  / 100000)
sim3.res <- 4953
...
sim4 <- (c(
  ...
  101631,103048,103451,102722,100487, 99349, 97266, 97488)
  / 100000)
sim4.res <- 92987
...
sim5 <- (c(
  ...
  101959,104118,101075, 98816, 96174,102206,104203,103607,102848, 98581,100217,
   ...
   99565, 98242, 96095, 97625, 97198, 96849, 93082, 91292)
  / 100000)
sim5.res <- -3892
...
extr <- (c(
  ...
  101135,101125,100388, 98194, 98419,100872,102571,105179,100641, 99465, 92140,
   ...
   78500, 81997, 83174, 81684, 77542, 76235, 73273, 72061)
  / 100000)
extr.res <- -1138
