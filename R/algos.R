...
f1k.in <- c(
  df$f1k.in,            66140, 66140, 66140, 66140, 66140, 66140, 66140, 66140,
   ...
   69573, 69573, 69573, 69573)  # (1225) 3
f1k.val <- c(
...
# Perf:    1st 2nd 3rd  Pts(2x1x0)  : day 13
# sim1       5   0   8   10
# fid        8   1   5   17
# et         1  13   1   15
