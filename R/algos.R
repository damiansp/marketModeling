...
sp.actual <- c(
  df$sp.actual,   5827,  5836,  5843,  5950,  5937,  5997,  6049,  6086,  6119,
    ...
    5936,  5970,  5971,  5939,  6000,  6006,  6039,  6022,  6045,  5977)
...
fid.val <- c(
  ...
  274490,275589,276288,275995,277970,278815,280617,279786,279950,276958) #
...
f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   ...
   57760, 57760, 57760, 58451, 58451, 58451, 58451, 58451, 58451, 58451) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   ...
   93148, 93520, 94071, 95552, 95232, 96020, 96059, 96548, 96353, 96510) #
...
self.mng.val <- c(
  df$self.mng.val, 
   ...
   23473, 23611, 23703, 23709, 23925, 23969, 24090, 24013, 23986, 23694)  #
...
et.in <- c(
  ...
  101985,101985,101985,101985,101985,101985,101985,101985,101985,101985) #
et.val <-c(
  ...
  237290,238238,238709,238172,239329,240919,242985,242020,242433,239954) #
...
sim1 <- (c(
  ...
  102560,104696,106303,104270,105848,107065,107121,106545,106189,102800)
  / 100000)
sim1.res <- 42059
...
sim2 <- (c(
  ...
  112913,115031,116087,115452,117518,117768,117696,117231,116822,112143)
  / 100000)
sim2.res <- -1974
...
sim3 <- (c(
  ...
  108213,110279,111840,110733,112616,113362,114197,113607,112858,108195)
  / 100000)
sim3.res <- 11711
...
sim4 <- (c(
  ...
  109122,111736,113743,112003,113386,115331,115828,115257,114871,111260)
  / 100000)
sim4.res <- 28889
...
sim5 <- (c(
  ...
  110912,112269,113596,111725,115434,114480,113391,113506,111695,107384)
  / 100000)
sim5.res <- 12417
...
extr <- (c(
  ...
  115243,118864,119507,116880,119579,119492,119722,121953,123512,120599)
  / 100000)
extr.res <- 142
