...
(fid.amt <- fid.val[length(fid.val)])                # [179159 199449]
(et.amt <- et.val[length(et.val)])                   # [130010 145591]
(f1k.total <- f1k.val[length(f1k.val)])              # [ 18063  20555] 
(self.mng.amt <- self.mng.val[length(self.mng.val)]) # [  9514  10379]
