...
sp.actual <- c(
  df$sp.actual,   5827,  5836,  5843,  5950, 5937,  5997,  6049, 6086,  6119,
    6101,  6012,  6068,  6039,  6071,  6041, 5995,  6038,  6061, 6084,  6026)
...
fid.val <- c(
  ...
  264323,265178,266072,266541,268886,266966,266306,266836,267983,268732,266090) #

f1k.in <- c(
  df$f1k.in,     52664, 52664, 52664, 52664, 53385, 53385, 53385, 53385, 53385,
   54088, 54088, 54088, 54088, 54088, 54088, 54088, 54088, 54088, 54794, 54794) # (1125.13)
f1k.val <- c(
  df$f1k.val,    82324, 82169, 82228, 82282, 83645, 83548, 84187, 84966, 85417,
   86877, 86687, 85482, 86377, 86028, 86597, 86145, 85505, 86165, 87586, 87833) #
...
self.mng.val <- c(
  df$self.mng.val, 
   ...
   17937, 17950, 17966, 17951, 18100, 17981, 17925, 18049, 18151, 18153, 18080)  #
...
et.val <-c(
  ...
  215513,217232,218083,218359,220065,218102,217139,217036,217815,218562,215879) #

sim1 <- (c(
         100000,100000,100181,100920,102382,102281,101603,103160,104907,104306,
  104823,106238,107565,107041,109842,109042,107404,107212,110907,112705,111027)
  / 100000)
sim1.res <- 55308
...
sim2 <- (c(
  ...
  106168,106180,109058,108848,110943,109775,107708,107689,109993,111953,109274)
  / 100000)
sim2.res <- 53719
...
sim4 <- (c(
  ...
  103325,105111,106746,106348,109165,108556,106282,106247,109595,111455,108689)
  / 100000)
sim4.res <- 53605
...
sim5 <- (c(
  ...
  105501,106753,108745,108704,110745,109261,106735,106840,109390,110814,107889)
  / 100000)
sim5.res <- 51238
...
extr <- (c(
   ...
   99729, 99185,101753,100747,103563,101707, 98628, 98969,103628,106584,102432)
  / 100000)
extr.res <- 1184
