...
SP <- c(
  ...
  2642,2665,2652,2640,2681,2704,2707,2725,2738)
...
FidIn <- c(
  ...
  45015,45015,45015,45015,45015,45015,45015,45015,45015,45427,45427,45427) #
FidVal <- c(
  45906,46052,45493,46088,47191,47852,48916,49049,48798,48236,49201,49406,49967,
  50698,48705,48711,49409,49903,49040,48365,49351,50699,51076,51509,51800)
Fid <- FidVal / FidIn
Fid <- Fid / Fid[1]
...
f1kIn <- c(
  ...
  43833,43833,43833,43833,43833,43833,43833,43833,44758,44758,44758,44758) #
f1kVal <- c(
  42436,42647,42639,42779,42780,43015,43187,43337,43413,43394,44316,44471,44646,
  44647,44866,44594,44592,44680,44640,44618,44619,45550,46084,46087,46231)
f1k <- f1kVal / f1kIn
f1k <- f1k / f1k[1]
...
OHIn <- c(
  ...
  35270,35270,35270,35270,35270,35270,35270,35270,35270,35270,35270,35270) #
  
OHVal <- c(
  35943,35992,35768,36109,37060,37368,37821,37530,37526,37167,37167,37114,37539,
  38110,37414,37624,37624,37624,37624,37624,37624,38228,38620,39367,39488)
OH <- OHVal / OHIn
OH <- OH / OH[1]
OHd <- dailyChange(OH)
